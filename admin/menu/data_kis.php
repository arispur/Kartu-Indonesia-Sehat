...
<body>
	...
	<div class="col-xs-12 col-md-8">
		...
		?>
		<a class="btn btn-sm btn-success" href="?menu=tambah_kis">Tambah Data</a>
	...
	<table class="table table-hover">
		...
		?>
			<tr>
				...
				<a title="Edit" href="?menu=edit_kis&nomor_kartu=<?php echo $data['nomor_kartu']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> |
				<a onclick="return confirm('Apakah anda yakin akan menghapusnya ?');" title="Delete" href="?menu=hapus_kis&nomor_kartu=<?php echo $data['nomor_kartu']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> |
				<a title="Print KIS" href="?menu=print_kis&nomor_kartu=<?php echo $data['nomor_kartu']; ?>"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></a>
				</td>
			</tr>
			<?php } } ?>
		</tbody>
